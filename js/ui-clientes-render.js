...
function renderizarConteudo() {
  ...
  if (abaAtual === 'estoque') {
    ...
    const kbdStyle = 'background:var(--paper-dim,#f3f4f6);border:1px solid var(--line,#d1d5db);border-radius:5px;padding:2px 8px;font-family:monospace;font-size:0.8rem;white-space:nowrap;';
    main.innerHTML = `
      <div class="page">
